...
struct API {
    ...
    static func getRestaurants(completion: @escaping ([Restaurant]?) -> Void) {
        ...
        let apikey = "wMXcDpTJP2fnqBvkNCU1lYkotdc5H4tB9cmVo2K8AfYGR0HIfPIls8hAX_1Q2PaeYRXWCFVgsbonLyZr-DL7b_y8mg471jXzOvcQViF9aM3eubvOzB880kRyFwUmY3Yx"
        ...
        let task = session.dataTask(with: request) { (data, response, error) in
            ...
            if let error = error {
                ...
                // Get array of restaurant dictinaries
